...
public class CResultadoModal  implements java.io.Serializable {
    private br.com.correios.CModal[] servicosModal;

    public CResultadoModal() {
    }

    public CResultadoModal(
           br.com.correios.CModal[] servicosModal) {
     ...
     */
    public br.com.correios.CModal[] getServicosModal() {
        return servicosModal;
    }
     ...
     * @param servicosModal
     */
    public void setServicosModal(br.com.correios.CModal[] servicosModal) {
        this.servicosModal = servicosModal;
    }
