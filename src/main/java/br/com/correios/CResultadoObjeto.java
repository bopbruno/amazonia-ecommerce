...
public class CResultadoObjeto  implements java.io.Serializable {
    private br.com.correios.CObjeto[] objetos;

    public CResultadoObjeto() {
    }

    public CResultadoObjeto(
           br.com.correios.CObjeto[] objetos) {
     ...
     * @return objetos
     */
    public br.com.correios.CObjeto[] getObjetos() {
        return objetos;
    }
     ...
     * @param objetos
     */
    public void setObjetos(br.com.correios.CObjeto[] objetos) {
        this.objetos = objetos;
    }
