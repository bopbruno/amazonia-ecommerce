...
public class CalcPrecoPrazoWSLocator extends org.apache.axis.client.Service implements br.com.correios.CalcPrecoPrazoWS {
    ...
    public br.com.correios.CalcPrecoPrazoWSSoap getCalcPrecoPrazoWSSoap() throws javax.xml.rpc.ServiceException {
    ...
    public br.com.correios.CalcPrecoPrazoWSSoap getCalcPrecoPrazoWSSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.com.correios.CalcPrecoPrazoWSSoapStub _stub = new br.com.correios.CalcPrecoPrazoWSSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.com.correios.CalcPrecoPrazoWSSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                br.com.correios.CalcPrecoPrazoWSSoapStub _stub = new br.com.correios.CalcPrecoPrazoWSSoapStub(new java.net.URL(CalcPrecoPrazoWSSoap_address), this);
                _stub.setPortName(getCalcPrecoPrazoWSSoapWSDDServiceName());
                return _stub;
            }
        }
