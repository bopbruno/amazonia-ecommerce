...
public class CResultado  implements java.io.Serializable {
    private br.com.correios.CServico[] servicos;

    public CResultado() {
    }

    public CResultado(
           br.com.correios.CServico[] servicos) {
     ...
     * @return servicos
     */
    public br.com.correios.CServico[] getServicos() {
        return servicos;
    }
     ...
     * @param servicos
     */
    public void setServicos(br.com.correios.CServico[] servicos) {
        this.servicos = servicos;
    }
